...
import com.dinhtai.vpstest.databinding.ItemServiceBinding

class ServiceAdapter() : RecyclerView.Adapter<ServiceAdapter.BindingHolder>() {
    ...
    class BindingHolder(val binding: ItemServiceBinding) : RecyclerView.ViewHolder(binding.root)
}